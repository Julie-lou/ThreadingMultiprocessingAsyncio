...
def find_primes_in_range(file_url, chunk_size):
    ...
    # Flatten the list of results and separate primes and non-primes
    primes = []
    non_primes = []
...
def main():
    ...
    file_url = "https://raw.githubusercontent.com/Julie-lou/ThreadingMultiprocessingAsyncio/main/numberfile.txt"
